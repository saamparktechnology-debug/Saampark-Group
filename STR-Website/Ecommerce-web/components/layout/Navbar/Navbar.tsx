      ...
      <nav className={`${styles.nav} ${scrolled ? styles.scrolled : styles.transparent}`}>
        <div className={styles.inner}>
          ...
          <div className={styles.actions}>
            ...
            {/* Link back to Main Agency / 3D Site */}
            <a 
              href="http://localhost:8080" 
              className="btn btn-ghost btn-sm"
              style={{ fontSize: '0.8rem', fontWeight: 700, color: 'var(--color-primary-600)', border: '1px solid var(--color-primary-200)', borderRadius: '50px', padding: '0.35rem 0.85rem' }}
              title="Return to 3D Agency & Portfolio Showcase"
            >
              ✨ 3D Agency
            </a>

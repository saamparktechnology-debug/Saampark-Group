          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-extrabold text-sm block leading-tight">
                {isGstInvoice ? "Digital Tax Invoice Verified" : "Digital Invoice Verified"}
              </span>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-5">
          ...
          <div className="text-left sm:text-right space-y-1">
            ...
            <div className="text-xs text-zinc-500 space-y-0.5">
              <p><strong>Invoice Date & Time:</strong> {invoice.billDate || "06 Aug 2026"} {invoice.billTime ? `• ${invoice.billTime}` : (invoice.createdAt ? `• ${new Date(invoice.createdAt).toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit", hour12: true })}` : "")}</p>

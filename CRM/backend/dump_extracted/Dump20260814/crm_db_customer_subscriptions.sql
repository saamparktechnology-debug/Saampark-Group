...
CREATE TABLE `customer_subscriptions` (
  ...
  `status` enum('active','expired','cancelled','pending') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  ...
  CONSTRAINT `customer_subscriptions_ibfk_2` FOREIGN KEY (`package_id`) REFERENCES `subscription_packages` (`id`) ON DELETE RESTRICT
...
-- Dump completed on 2026-08-14 17:02:47
